...
common_path2     = "/raid/raid7/lucien/SUSY/RPV/SkimTree/ZMuMu/2018-06-19/BkgMC_ZMuMuSelection_v1/"
#common_path2    = "/raid/raid7/kshi/SUSY/RPV/SkimTree/mc/ZToMuMu/"
inUFTier2       = False
...
sampleNames = [n for n in os.listdir(common_path2) if os.path.isdir(os.path.join(common_path2, n))]
allMCSamples = []
for sampleName in sampleNames:
    print(sampleName)
    tmpList = ComponentList([Component(sampleName,"/".join([common_path2,sampleName,fileName]),"Events",inUFTier2,maxEvents=-1)],)
