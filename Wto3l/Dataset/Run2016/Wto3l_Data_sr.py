...
Data_sr_Run2016_cmpList = ComponentList(
        [
            ...
            Component("Data_sr_Run2016_totaldata",dataTreeDir+"total_Data.root","passedEvents",inUFTier2=inUFTier2)
        ]
        )
Data_sr_Run2016 = Dataset(
        "Data_sr_Run2016",
