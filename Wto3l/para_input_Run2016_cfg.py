...
from Wto3l.StatTools.ParaYieldProducer import ParaYieldProducer
...
input_channel_dict  ={
        "NNP_SR": LambdaFunc('event: '+' and '.join([NNP_str,SR_str])),
        "PPN_SR": LambdaFunc('event: '+' and '.join([PPN_str,SR_str])),
