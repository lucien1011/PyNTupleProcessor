...
class JSONProducer( Analyzer ):
    ...
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(JSONProducer, self).__init__(cfg_ana, cfg_comp, looperName)
    ...
    def beginLoop(self, setup):
        super(JSONProducer,self).beginLoop(setup)
    ...
    def write(self, setup):
        super(JSONProducer, self).write(setup)
