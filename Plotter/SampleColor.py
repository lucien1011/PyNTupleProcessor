...
sampleColorDict = { 
                ...
                #Zprime
                "zpToMuMu_M1": ROOT.kViolet+1,
                "zpToMuMu_M2": ROOT.kViolet+2,
                "zpToMuMu_M3": ROOT.kViolet+3,
                "zpToMuMu_M4": ROOT.kViolet+4,
                "zpToMuMu_M5": ROOT.kViolet+5,
                "zpToMuMu_M10": ROOT.kOrange+1,
                "zpToMuMu_M15": ROOT.kOrange+2,
                "zpToMuMu_M20": ROOT.kOrange+3,
                "zpToMuMu_M25": ROOT.kOrange+4,
                "zpToMuMu_M30": ROOT.kOrange+5,
                "zpToMuMu_M35": ROOT.kRed+1,
                "zpToMuMu_M40": ROOT.kRed+2,
                "zpToMuMu_M45": ROOT.kRed+3,
                "zpToMuMu_M50": ROOT.kRed+4,
                "zpToMuMu_M55": ROOT.kRed+5,
                "zpToMuMu_M60": ROOT.kBlue+1,
                "zpToMuMu_M65": ROOT.kBlue+2,
                "zpToMuMu_M70": ROOT.kBlue+3,
                "zpToMuMu_M75": ROOT.kBlue+4,
                "zpToMuMu_M80": ROOT.kBlue+5,
                "zpToMuMu_M85": ROOT.kGreen+1,
                "zpToMuMu_M90": ROOT.kGreen+2,
