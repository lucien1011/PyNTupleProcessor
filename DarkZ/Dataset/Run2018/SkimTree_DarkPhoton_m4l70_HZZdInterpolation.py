...
sigSkimTreeDir          = system.getStoragePath()+"/lucien/Higgs/DarkZ-NTuple/20191201/SkimTree_DarkPhoton_Run2018Data_m4l70/"
sigSkimTreeDir2         = system.getStoragePath()+"/lucien/Higgs/DarkZ-NTuple/20191204/SkimTree_DarkPhoton_Run2018Data_m4l70/"
sigTreeDir              = "/cmsuf/data/store/user/t2/users/klo/Higgs/HToZZd/102X_MCProd_191127/"
inUFTier2               = False
...
for m in mass_points:
    inputFilePath = os.path.join(sigSkimTreeDir,fileNameTemplate%m) if m not in range(1,5) else os.path.join(sigSkimTreeDir2,fileNameTemplate%m)
    tmpDataset = Dataset(
            datasetName%m,
            ComponentList(
