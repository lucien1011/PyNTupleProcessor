...
Data_3P1F_Run2016 = copy.deepcopy(Data_Run2016)
Data_3P1F_Run2016.name = "Data_3P1F"
Data_3P1F_Run2016.selection = LambdaFunc("x: x.nFailedLeptonsZ2[0] == 1")
Data_2P2F_Run2016 = copy.deepcopy(Data_Run2016)
Data_2P2F_Run2016.name = "Data_PredCR_2P2F"
Data_2P2F_Run2016.selection = LambdaFunc("x: x.nFailedLeptonsZ2[0] == 2")

#out_path = "ParaInput/ZXCR_m4l130To170_Nominal/2019-06-18_v1_Run2016/"
out_path = "ParaInput/ZXCR_m4l130To170_HZZ/2019-06-18_v1_Run2016/"
...
componentList           = [Data_3P1F_Run2016,Data_2P2F_Run2016,WZTo3LNu,ZGToLLG,] 
