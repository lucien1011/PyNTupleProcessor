...
plots = [
		...
		Plot("Tau21",       ["TH1D","Tau21","AK8 jet #tau_{2}/#tau_{1}",50,0,1],	LambdaFunc('x: [ tau2/x.theJetAK8NjettinessTau1_JetSubCalc_PtOrdered[itau] for itau,tau2 in enumerate(x.theJetAK8NjettinessTau2_JetSubCalc_PtOrdered)]'), isCollection=True),
		Plot("Tau32",       ["TH1D","Tau32","AK8 jet #tau_{3}/#tau_{2}",50,0,1],	LambdaFunc('x: [ tau3/x.theJetAK8NjettinessTau2_JetSubCalc_PtOrdered[itau] for itau,tau3 in enumerate(x.theJetAK8NjettinessTau3_JetSubCalc_PtOrdered)]'), isCollection=True),
