...
inverMetSkimmer         = METSkimmer("METSkimmer",invert=True)
...
rpv_skim_sequence = Sequence()
rpv_skim_sequence.add(leptonProducer)
rpv_skim_sequence.add(jetProducer)
rpv_skim_sequence.add(metFilter)
rpv_skim_sequence.add(baselineSkimmer)
rpv_skim_sequence.add(leptonCatProducer)
rpv_skim_sequence.add(llHtSkimmer)
rpv_skim_sequence.add(hltSkimmer)

low_met_sequence = Sequence()
low_met_sequence.add(inverMetSkimmer)
low_met_sequence.add(leptonProducer)
low_met_sequence.add(jetProducer)
low_met_sequence.add(metFilter)
low_met_sequence.add(baselineSkimmer)
low_met_sequence.add(leptonCatProducer)
low_met_sequence.add(llHtSkimmer)
low_met_sequence.add(hltSkimmer)
low_met_sequence.add(rpvSkimmer)
low_met_sequence.add(xsWeighter)
low_met_sequence.add(hltWeighter)
...
gamma_cr_sequence = Sequence()
gamma_cr_sequence.add(metFilter)
gamma_cr_sequence.add(leptonProducer)
gamma_cr_sequence.add(jetProducer)
gamma_cr_sequence.add(phoProducer)
gamma_cr_sequence.add(gammaCRSkimmer)
gamma_cr_sequence.add(xsWeighter)
