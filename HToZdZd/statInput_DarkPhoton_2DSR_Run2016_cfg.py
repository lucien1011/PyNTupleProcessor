...
statProducer            = StatInputProducer("StatInputProducer",
        ...
        channelDict     = {
                            "MuMu": BaseObject(
                                        "MuMu",
                                        histKey = "MuMu",
                                        setting = ["TH2D","MuMu","",40000,0.,80.,40000,0.,80.,],
                            ...
                            "ElEl": BaseObject(
                                        "ElEl",
                                        histKey = "ElEl",
                                        setting = ["TH2D","ElEl","",40000,0.,80.,40000,0.,80.,],
                            ...
                            "ElMu": BaseObject(
                                        "ElMu",
                                        histKey = "ElMu",
                                        setting = ["TH2D","ElMu","",40000,0.,80.,40000,0.,80.,],
                            ...
                            "MuEl": BaseObject(
                                        "MuEl",
                                        histKey = "MuEl",
                                        setting = ["TH2D","MuEl","",40000,0.,80.,40000,0.,80.,],
