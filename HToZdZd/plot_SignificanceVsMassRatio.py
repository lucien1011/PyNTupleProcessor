#####################################################################################################
## PURPOSE: Make plots of significance vs. ZmassRatioDifferenceCuts for each Zd mass point.
...
masslist        = [4,5,6,7,8,9,10,15,20,25,30,35,40,45,50,55,60]             # Zd mass points you want to run over
...
# Inputs
dirToRootFiles  = "/raid/raid7/rosedj1/Higgs/HToZdZd/DarkPhotonSR/DataMCDistributions/20190228_MassRatioCuts_allmasses/"
...
bkgFileGlobName = "[!H]*/DataMCDistribution.root"

# Outputs
haddOutFileName = "allhaddedbkgs.root" 
outputDir       = "/home/rosedj1/public_html/HToZdZd/SignificancePlots/AllSignalSamples/"
...
#____________________________________________________________________________________________________
# hadd all bkg files
if (HaddFiles): haddFiles(haddOutPath,dirToRootFiles,haddOutFileName,bkgFileGlobName)
...
if (AnalyzeFiles):
    for zdmass in masslist:
        ...
        for finalstate in finalstatelist:
            ...
            # Load files
            sigArr, sigErrArr = getIntegralArr(tempSignalPath, finalstate, massratio_cuts)
            bkgArr, bkgErrArr = getIntegralArr(bkgPath,        finalstate, massratio_cuts)
