...
outpath="DarkPhotonSR/DataMCDistributions/RadiusCuts/SignifRadiusCut_mZdZDMASS_fixedplotrange/"
template="template_plot_DarkPhoton_signif_radiuscut_fixedplotrange_cfg.py"
deletefile="DELETEtemp_plot_DarkPhoton_signif_radiuscut_fixedplotrange_cfg.py"
