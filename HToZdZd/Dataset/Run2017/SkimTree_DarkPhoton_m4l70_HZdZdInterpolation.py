...
sigSkimTreeDir          = system.getStoragePath()+"/"+os.environ["USER"]+"/Higgs/DarkZ-NTuple/20191201/SkimTree_HToZdZd_Run2017Data_m4l70_noZCandRatioCut/"
sigSkimTreeDir2         = system.getStoragePath()+"/"+os.environ["USER"]+"/Higgs/DarkZ-NTuple/20191204/SkimTree_HToZdZd_Run2017Data_m4l70_noZCandRatioCut/"
