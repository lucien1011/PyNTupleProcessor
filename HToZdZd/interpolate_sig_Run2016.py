...
from HToZdZd.Dataset.Run2016.SkimTree_DarkPhoton_m4l70_HZdZd import mass_points 
...
in_path         = "DarkPhotonSR/StatInput/2019-12-02_Run2016/"
...
signals = [
                ...
                SignalModel("HToZdZd_M"+str(m),m,yieldFactor=1. if m!=4 else 2.) for m in mass_points
            ]
bins    = [
            Bin("MuMu",0.02),
            Bin("ElMu",0.02),
