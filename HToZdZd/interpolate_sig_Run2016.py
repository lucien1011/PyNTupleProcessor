...
from HToZdZd.Dataset.Run2016.SkimTree_DarkPhoton_m4l70_HZdZdInterpolation import mass_points 
...
in_path         = "DarkPhotonSR/StatInput/2019-12-04_SignalInterpolation_Run2016/"
...
print("Mass points: "+", ".join([str(m) for m in mass_points]))
