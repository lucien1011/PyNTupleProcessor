...
for p in plots:
    ...
    p.plotSetting.leg_name_dict = {
            "HToZdZd_M30": "H #rightarrow Z_{d} Z_{d}, m_{X} = 30 GeV, #kappa = 0.0001",
            "HToZdZd_M5": "H #rightarrow Z_{d} Z_{d}, m_{X} = 5 GeV, #kappa = 0.0001",
            "HToZdZd_M50": "H #rightarrow Z_{d} Z_{d}, m_{X} = 50 GeV, #kappa = 0.0001",
            "ZPlusX": "Z+X",
            }
